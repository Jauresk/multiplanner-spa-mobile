        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View style={[styles.summaryContainer, {
            ...
            <View style={styles.view}>
              <Text style={[styles.viewLeft, { color: dark ? COLORS.grayscale200 : COLORS.grayscale700 }]}>Event</Text>
              <Text style={[styles.viewRight, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>National Music Event</Text>
            </View>
            <View style={styles.view}>
            ...
            <View style={styles.view}>
              <Text style={[styles.viewLeft, { color: dark ? COLORS.grayscale200 : COLORS.grayscale700 }]}>Booking Date</Text>
              <Text style={[styles.viewRight, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>December 23, 2024</Text>
            </View>
            <View style={styles.view}>
              <Text style={[styles.viewLeft, { color: dark ? COLORS.grayscale200 : COLORS.grayscale700 }]}>Start Time</Text>
              <Text style={[styles.viewRight, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>09:00 AM</Text>
            </View>
            <View style={styles.view}>
              <Text style={[styles.viewLeft, { color: dark ? COLORS.grayscale200 : COLORS.grayscale700 }]}>End Time</Text>
              <Text style={[styles.viewRight, { color: dark ? COLORS.white : COLORS.greyscale900 }]}>02:00 PM</Text>
            </View>
          </View>
          ...
          <View style={[styles.summaryContainer, {
            ...
            <View style={styles.view}>
              <Text style={[styles.viewLeft, { color: dark ? COLORS.grayscale200 : COLORS.grayscale700 }]}>Amount (2 days)</Text>
