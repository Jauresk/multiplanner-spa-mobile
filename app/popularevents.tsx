...
import { allEvents, categories, facilities, ratings, recommendedEvents } from '../data';
...
const PopularEvents: React.FC<SearchProps> = () => {
    ...
    const renderContent = () => {
        ...
        const [filteredEvents, setFilteredEvents] = useState<Event[]>(recommendedEvents);
