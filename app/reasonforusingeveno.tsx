...
import ReasonEvenoItem from '@/components/ReasonEvenoItem';

const reasons = [
    "Book Tickets for Events",
    "Reserve Spots for Workshops",
    "Get Exclusive Event Access",
...
export default ReasonForUsingEveno